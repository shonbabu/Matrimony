                  ...
                  <div class="menu-area">
                     <div class="limit-box">
                        <nav class="main-menu">
							...
							<li class="active"><a href="viewstory.php">Success Story</a> </li>
...
$db=new DatabaseCon();
$s1="select count(*) as cnt from tbl_story where status='true'";
$rs1=$db->selectData($s1);
$row1=mysqli_fetch_array($rs1);
$cnt=$row1['cnt'];
?>
<h3><br/>Total Success Stories: <?php echo $cnt;?></h3>
<a href="sreports.php"><button class="btn btn-danger"> CLICK FOR REPORT</button></a>
...
$s="select*from tbl_story where status!='true'";
$rs=$db->selectData($s);
...
<td><?php echo $row['bgroom'];?></td>
<td><?php echo $row['wdate'];?></td>

<td><a href="delstory.php?n=<?php echo $row['sid'];?>">Delete</a>|<a href="appstory.php?n=<?php echo $row['sid'];?>">Approve</a></td>
</tr>
