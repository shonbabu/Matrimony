...
<th style="padding:10px;">Package Selected</th>
<th style="padding:10px;">Valid thru</th>
</tr>
<?php
include('DatabaseCon.php');
$db=new DatabaseCon();
$s="select * from tbl_user where status='false'";
$rs=$db->selectData($s);
...
<?php
$s1="select packname from tbl_package where pkid=".$row['pack'];
$rs1=$db->selectData($s1);
$rw=mysqli_fetch_array($rs1);
?>
<td><?php echo $rw['packname'];?></td>
<td><?php echo $row['edate'];?></td>
<td><a href="approve.php?uid=<?php echo $row['uid'];?>" style="color:red">Approve</a></td>
