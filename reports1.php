...
$db=new DatabaseCon();
?>
	<a href="reports1.php"><button class="btn btn-danger"> Validity Expiring Members</button></a>

<?php
$m=Date('m');
$y=Date('Y');
$s1="select count(*) as cnt from tbl_user where Extract(Month from edate)=$m and Extract(Year from edate)=$y";
...
<h3><br/>Total Members: <?php echo $cnt;?></h3>
    ...
    <div class="contact">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
						<a href="preports1.php" target="_blank"><button class="btn btn-primary" style="float:right"> Proceed to Print</button></a>
...
$s="select*from tbl_user where Extract(Month from edate)=$m and Extract(Year from edate)=$y";
$rs=$db->selectData($s);
