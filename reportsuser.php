...
$s="select*from tbl_user where status='true' and apdate between '".$_GET['d1']."' and '".$_GET['d2']."'";
$rs=$db->selectData($s);
...
<td><a href="details1.php?uid=<?php echo $row['uid'];?>" style="color:maroon">Details</a></td>
