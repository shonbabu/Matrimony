...
$db=new DatabaseCon();
$s1="select count(*) as cnt from tbl_user where gender='F' and status='true'";
$rs1=$db->selectData($s1);
$row1=mysqli_fetch_array($rs1);
$cnt=$row1['cnt'];
?>
<h3><br/>Total Female Users: <?php echo $cnt;?></h3>
                    </div>
                </div>
            </div>
        </div>
...
$s="select*from tbl_user where gender='F' and status='true'";
$rs=$db->selectData($s);
