            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
						...
						<a href="viewuserf.php"><button class="btn btn-danger">Female Users</button></a>
						<a href="reports.php?pid=0"><button class="btn btn-danger">Reports</button></a>
						
											<form action="reportsuser.php"><br>
					...
					$db=new DatabaseCon();
					$s1="select count(*) as cnt from tbl_user where status='true'";
					$rs1=$db->selectData($s1);
					$row1=mysqli_fetch_array($rs1);
					$cnt=$row1['cnt'];
					?>
<h3><br/>Total Users: <?php echo $cnt;?></h3>
                    </div>
                </div>
            </div>
        </div>
...
$s="select*from tbl_user where status='true'";
$rs=$db->selectData($s);
...
<td><a href="details1.php?uid=<?php echo $row['uid'];?>" style="color:#ff6600">Details</a></td>

<td><a href="block.php?uid=<?php echo $row['uid'];?>" style="color:red">Block</a></td>
