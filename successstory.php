...
?>						
<form name="frm" action="storyaction.php" method="post" enctype="multipart/form-data">
<table>
<tr>
<th>Bride</th>
<?php 
if($g=="F"){
?>
<td><input type="text" name="bride" readonly value="<?php echo $rw['firstname'];?> <?php echo $rw['lastname'];?>"></td>
<?php }else{ ?>
<td><input type="text" name="bride"></td>
<?php } ?>
</tr>
<tr>
<th>Bride Groom</th>
...
if($g=="F"){
?>
<td><input type="text" name="bgroom"></td>
<?php }else{ ?>
<td><input type="text" name="bgroom" readonly value="<?php echo $rw['firstname'];?> <?php echo $rw['lastname'];?>"></td>
<?php } ?>
</tr>
<tr>
<th>Wedding date</th>
